...
def display_map():
    ...
    name = "Chaerul Candra Pranugrah - D0221509 (SIG Informatika B)"
...
st.markdown("<h3> Chaerul Candra Pranugrah - D0221509 (SIG Informatika B) </h3>", unsafe_allow_html=True,)
display_map()
